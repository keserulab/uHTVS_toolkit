...
dd_loc = ""                                								# Location of the deepdocking python scripts  (the main and sub script)
...
autodock_workflow_script_loc = ""                             						# Location of the autodock workflow script
ad_grid = ""                    									# Location of the AutoDock maps.fld file, including file name
gpus = ''                                                                                    		# GPU-s to be used. Comma seperated GPU devices to use (use nvidia-smi for help)(e.g. 0,1,2)
cpus =                                                                                        		# Number of CPUs-to use per subjob, for OpenBabel (total CPU usage at a time is: number of gpus * this number) 
sj =                                                                                          		# Number of subjobs
...
verbosity = ''                                                                        			# Verbose or scoresonly. Set verbose if autodock log file is required. verbose/scoresonly
#------------------------------------------------------------------------------------------------------------------------------------------------------------------------
