...
project_name = "Glide_example"                                                         				# Name of the project folder (this has to be made manually)
...
glide_workflow_script_loc = "../Workflow_scripts/"                             						# Location of the GlideHTVS workflow scripts
glide_grid = "../Example_files/Glide/3HA8_p38MAPK_grid_fulldefault.zip"                    									# Location of the Glide grid file (filename.zip), including file name
cpus = 8                                                                                       		# Number of CPUs to use for the docking process 
sj = 8                                                                                         		# Number of subjobs in the docking process
